...
- [Lecture slides](slides/day_1/IntroductionRDay1.qmd)
- Contents:
...
- Exercises:
  ...
  - [R studio version](handouts/day_1/ExerciseRStudio.html){target="_blank"}; [Exercise script](handouts/day_1/exercises_Day1_answer.R){target="_blank"}
- Answers: 
