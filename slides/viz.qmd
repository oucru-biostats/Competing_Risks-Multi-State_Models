...
- Purpose: express ideas or information in a coherent way
...
- Graphics grammar: 
  ...
  - Does not advise on the best choice of scale (linear, logarithmic), color or line type


## Main components of a statistical graph (R terminology)
...
Cartesian, polar, map projections. (Networks, trees have no coordinate
system)

separate panels (subfigures)

Not about [graph type](https://www.data-to-viz.com/); ($\approx$
language, words).\
Not about font size, background colour ... Some of these are specified
